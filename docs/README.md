...
| [adr/003-session-reliability-model.md](adr/003-session-reliability-model.md) | Accepted decision: facilitator-authoritative round state, versioned rounds, a values-free submission roster pulled on (re)connect, acknowledged submissions, stable client identity, role-asymmetric link state. The design anchor for #9, #60, #61, #62, #63 — stable client identity (#50), versioned rounds (#51), and single owner (#60) have landed; **acknowledged submissions (#61) and role-asymmetric link state (#62) remain decision only, not built**. |
